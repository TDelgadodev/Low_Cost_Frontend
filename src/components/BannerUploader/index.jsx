...
class BannerUploader extends Component {
  ...
  handleUpload = async () => {
    ...
    try {
      /* const response = await axios.post("http://localhost:3000/api/upload/upload-images", formData, { */
        const response = await axios.post("https://lowcostarg.com.ar/api/upload/upload-images", formData, {
        headers: {
  ...
  handleDeleteOldImages = async () => {
    try {
      ...
      const response = await axios.delete("https://lowcostarg.com.ar/api/upload/delete-images");
